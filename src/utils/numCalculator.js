export default function numCalculator(fullnameInput, birthdayInput) {
    ...
    const lyGiaiThangCaNhan = {
        ...
        10: 'NĂNG LƯỢNG MỚI, KẾ HOẠCH MỚI. Đây là tháng để bắt tay vào những kế hoạch mới, khởi đầu những điều mới. Các cơ hội mới sẽ đến với bạn, nên đừng ngại nắm bắt chúng. Đây cũng là thời điểm thích hợp để nắm bắt, hạ quyết tâm và suy nghĩ quyết đoán, nhằm kiểm soát tay lái điều khiển cuộc đời mình và nắm quyền chỉ huy. Hãy dũng cảm khác biệt, đổi mới và làm những điều bạn chưa bao giờ làm.',
        11: 'LẮNG NGHE NHIỀU HƠN, KIÊN NHẪN, CÁC MỐI QUAN HỆ. Đây là thời gian để bạn dành thời gian cho những người bạn quan tâm. Bạn nên dành thời gian để thu thập dữ liệu và học tính kiên nhẫn, bạn nên lùi lại một bước và nhẫn nại. Tìm kiếm sự cân bằng, bình yên, hòa hợp trong các mối quan hệ của bạn và sẵn sàng hợp tác với người khác. Hàn gắn những tổn thương trong quá khứ, biểu đạt cảm xúc của mình một cách lành mạnh, cũng như sẵn sàng đón nhận tình yêu.',
        12: 'THỂ HIỆN BẢN THÂN, GIAO LƯU, SÁNG TẠO, CHIA SẺ. Đây là tháng bạn dành thời gian cho bản thân, vui chơi, giao lưu tìm kiếm cơ hội. Dù chuyện gì đang xảy ra trong cuộc sống của bạn đi chăng nữa thì việc giữ thái độ lạc quan vẫn là rất quan trọng. Đây cũng là thời điểm để thể hiện bản thân cũng như chia sẻ những suy nghĩ và cảm nhận của bạn một cách thật lòng.'
    };
    ...
    const lyGiaiSoDuongdoi = {
        1: 'Những người có con số đường đời là số 1 có rất nhiều lợi thế về tiền bạc trong cuộc sống này. Là một người luôn phấn đấu để đạt được thành công trong mọi lĩnh vực, người số 1 đo lường thành công của mình trong cuộc sống theo số tiền mà bạn kiếm được. Bạn là một thỏi nam châm thu hút tiền bạc, cơ hội kiếm tiền đến với bạn nhiều không kể siết. Nếu biết nắm bắt những cơ hội quý hiếm, bạn sẽ dễ dàng trở thành đại gia chỉ sau một đêm.',
        2: 'Người mang con số đường đời là số 2 đại diện cho quan hệ đối tác và duy trì sự cân bằng trong các mối quan hệ. Bạn thường gặp khó khăn trong việc tự chủ, độc lập tài chính và có xu hướng so sánh bản thân mình với người khác. Là một người cần có được sự công nhận từ những người xung quanh, bạn thường cố gắng làm hài lòng mọi người, dù điều đó khiến bạn bị tổn thương. Bạn không thích có quá nhiều tiền, bạn sợ điều đó khiến mọi người nghĩ bạn là người giàu có tham lam, hoặc là người ích kỉ. Chính vì thế, bạn thường bỏ qua rất nhiều cơ hội tài chính trong cuộc đời.',
        3: 'Những người mang con số đường đời số 3 là người may mắn trong tài vận. Bạn nhận được rất nhiều cơ hội tài chính và bạn cũng giỏi trong việc nắm bắt chúng. Bạn luôn nỗ lực và chăm chỉ kiếm tiền, nhưng bạn chi tiêu cũng rất... hết mình. Bạn sẵn sàng chi ra một số tiền lớn cho một bữa tối sang chảnh, những buổi tiệc tùng, những trải nghiệm mới mẻ hoặc mua quà cho bạn bè, người thân. Bạn có xu hướng chi tiêu nhiều hơn những gì mà bạn kiếm được, vì thế lời khuyên cho bạn là hãy lập danh sách, kế hoạch cụ thể và học cách tiết kiệm ngay lúc này!',
        4: 'Những người có con số đường đời là số 4 luôn làm việc chăm chỉ và nỗ lực. Bạn trân trọng từng đồng tiền mà mình kiếm được. Bạn thực sự cảm nhận được sự khó khăn khi lao động kiếm tiền và luôn đấu tranh để có một cuộc sống tốt đẹp hơn. Bạn không phải người ki bo, keo kiệt nhưng bạn biết chi đồng tiền của mình đúng chỗ, vì thế ít khi nào bạn lâm vào cảnh khó khăn. Những người mang con số 4 là người coi trọng vật chất, tiền tài, nhưng không bao giờ làm những chuyện trái với lương tâm.',
        5: 'Những người mang con số đường đời là 5 thường đặt việc kiếm tiền và tiết kiệm tiền vào cuối danh sách ưu tiên của mình. Bởi lẽ, người số 5 luôn tìm kiếm sự tự do, bạn luôn có niềm tin rằng nếu cứ mải lao theo đồng tiền thì nó sẽ trói buộc bạn hoặc khiến bạn bị mắc kẹt trong một mê cung mà không thể nào thoát ra được. Chính vì thế, người số 5 ít khi nào đau đầu vì tiền. Mà cũng bởi vậy nên người số 5 có cuộc sống khá thoải mái, vô tư, vô lo.',
        6: 'Người mang con số đường đời là 6 không chỉ là một doanh nhân mà còn là một nhà từ nhiện. Bạn là người luôn hướng tới gia đình và cộng đồng. Bạn thường đặt lợi ích của người khác lên trên bản thân mình. Bạn chăm chỉ và nỗ lực kiếm tiền, nhưng điều đó không có nghĩa rằng bạn là một kẻ bất chấp vì tiền bạc. Bạn luôn cố gắng vì một cuộc sống đầy đủ, tiện nghi cho những người xung quanh. Đây cũng là người có tài năng trong lĩnh vực kinh doanh và tài chính, bạn thường tìm ra những cách thức khác thường và táo bạo để tạo ra sự giàu có cho bản thân, đồng thời để giúp đỡ người khác.',
        7: 'Những người có con số đường đời là 7 có suy nghĩ sâu xa, sắc bén. Những người này thường hay gặp nhiều thách thức về tài chính, nhưng luôn nhận được sự giúp đỡ kịp thời. Đây cũng là những người có thu nhập cao hơn so với những con số khác. Mặc dù tiền bạc không phải là vấn đề trọng tâm của người mang số 7 nhưng bạn biết sự cần thiết của nó trong cuộc sống này. ',
        8: 'Số 8 chính là con số của sự thịnh vượng. Bạn đặc biệt có năng khiếu trong lĩnh vực kinh doanh và tài chính. Thêm vào đó, tham vọng và động lực của bạn luôn giúp bạn có được chiến thắng về mặt vật chất. Những người mang con số đường đời 4 là những nhà quản lý bẩm sinh và có thể đạt được bất kì nấc thang nào mình muốn. Tuy nhiên, đây cũng là người thích sống một cuộc sống xa hoa, giàu có, nổi tiếng. Và bạn tin rằng, có nhiều tiền sẽ cho phép bạn có được tất cả những thứ đó.',
        9: 'Những người mang con số đường đời 9 luôn thu hút tiền bạc và không tốn quá nhiều công sức để kiếm tiền. Tài vận cũng không phải là điều mà người số 9 theo đuổi trong cuộc đời. Bạn là người nhân hậu, từ bi và rộng lượng. Đồng thời, bạn cũng là một người rất hào phóng, sẵn sàng chia sẻ những đồng tiền cuối cùng trong người mình cho người khác chỉ vì thương cảm hoàn cảnh của họ. Người số 9 thường không thể trở thành đại gia được nhưng bạn lại có được những hạnh phúc hơn thế.'
    };
    ...
    const lyGiaiSoLinhHon = {
        ...
        '22/4': 'Bạn là người có tầm nhìn xa và luôn theo đuổi cảm giác an toàn trong cuộc sống. Những quan điểm, góc nhìn không tưởng của bạn truyền cảm hứng cho những người khác. Bạn là người ổn định, thực tế, sẵn sàng học tập để tạo ra những nền tảng vững chắc trong tương lai. Bạn cũng có khả năng trở thành một nhà lãnh đạo, quản lý và tổ chức nhân sự tuyệ vời. ',
        '11/2': 'Bạn sẽ phải trải qua rất nhiều điều trong cuộc sống để trở thành một nhà lãnh đạo cao cả và có sự thấu cảm. Bạn nhạy cảm, dễ thương, sẵn sàng kết bạn với bất kì ai. Bạn khó có thể nhận thấy mình tài năng đến mức nào. Đừng nghi ngờ bản thân, bạn sinh ra là để tỏa sáng. Bạn cũng là một người sáng tạo và mang lại cảm giác êm dịu cho người khác. ',
        '33/6': 'Bạn sẵn sàng trao đi tình yêu thương vô điều kiện cho những người xung quanh mình. Bạn thậm chí có thể làm bất cứ điều gì cần thiết để mang lại nụ cười trên khuôn mặt của ai đó. Mọi người thường bị bạn thu hút bởi bạn là một người lắng nghe xuất sắc và là một người thấu cảm. Bạn cũng là một người thông minh và có thể trở thành một cố vấn tốt. Chính vì thế, mọi người thường tìm đến với bạn để nói những vấn đề của họ và họ thường cảm thấy tốt hơn sau khi trò chuyện với bạn.'
    };
